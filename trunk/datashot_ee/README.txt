...
[Configure database, see datashot_thick for schema.]
...
(2) Enable maven: Right click on each project in Package Explorer, 
    select Maven/Enable Dependency Management from the popup menu.
...
(4) Deploy resulting artifact 
    datashot_ee/target/datashot-ear-1.0.0-SNAPSHOT.ear to 
    Glassfish container.
    Web application will be at localhost:8080/ic/   
